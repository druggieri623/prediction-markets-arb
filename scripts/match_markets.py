...
def main():
    ...
    try:
        ...
        print(f"Filtered to {len(filtered_matches)} matches with {args.min_confidence}+ confidence\n")
        ...
        print(f"High Confidence Matches: {sum(1 for m in matches if m.confidence == 'high')}")
        print(f"Medium Confidence Matches: {sum(1 for m in matches if m.confidence == 'medium')}")
        print(f"Low Confidence Matches: {sum(1 for m in matches if m.confidence == 'low')}")
